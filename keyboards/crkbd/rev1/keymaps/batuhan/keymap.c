...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT_split_3x6_3_wrapper(
        B_ENC0, _BL1_5_, _BR1_5_, B_ENC1,
                _BL2_6_, _BR2_6_,
                _BL3_6_, _BR3_6_,
                _BL4_3_, _BR4_3_
    ),
    [_DVOR] = LAYOUT_split_3x6_3_wrapper(
        B_ENC0, _DL1_5_, _DR1_5_, B_ENC1,
                _DL2_6_, _DR2_6_,
                _DL3_6_, _DR3_6_,
                _DL4_3_, _DR4_3_
    ),
...
#   ifdef RGB_MATRIX_ENABLE
    g_led_config = (led_config_t){{
        ...
        //          26    27       25    26
        //           03 02 01     03 02 01
        { 95,  63}, { 80,  58}, { 60,  55}, {  0,  41}, { 16,  42}, { 33,  37},
        { 50,  35}, { 68,  37}, { 85,  39}, { 85,  21}, { 68,  19}, { 50,  13},
        { 33,  20}, { 16,  24}, {  0,  24}, {  0,   7}, { 16,   7}, { 33,   3},
        { 50,   0}, { 68,   2}, { 85,   4}, { 85,  16}, { 50,  13}, { 16,  20},
        { 16,  38}, { 50,  48}, { 85,  52}, {164,  55}, {144,  58}, {129,  63},
...
bool oled_task_keymap(void) {
    // TODO: Implement OLED display functions
    // if (is_keyboard_left()) {
