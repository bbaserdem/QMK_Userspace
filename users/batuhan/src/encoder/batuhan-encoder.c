...
void reset_encoder_state(void) {
    userspace_config.bits.e0base  = ENC_MODE_VOLUME;   // Volume control
    userspace_config.bits.e0point = ENC_MODE_LATERAL;  // Mouse horizontal
    userspace_config.bits.e0rgb   = ENC_MODE_HUE;      // RGB hue
    userspace_config.bits.e1base  = ENC_MODE_SONG;     // Song control
    userspace_config.bits.e1point = ENC_MODE_VERTICAL; // Mouse vertical
    userspace_config.bits.e1rgb   = ENC_MODE_VALUE;    // RGB brightness
}
...
// The list of actions to be used, if there are no modifiers pressed.
